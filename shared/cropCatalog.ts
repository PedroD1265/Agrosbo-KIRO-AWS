...
export const CROP_CATALOG: CropDef[] = [
  {
    ...
    stages: [
      { stageKey: "almacigo", label: "Almácigo", expectedStartDay: 0, expectedEndDay: 30,
      ...
      { stageKey: "trasplante", label: "Trasplante", expectedStartDay: 30, expectedEndDay: 45,
        irrigationNotes: "Riego de asentamiento; evitar exceso.",
        taskSuggestions: ["Trasplantar al sitio definitivo", "Tutorado inicial"] },
      { stageKey: "vegetativo", label: "Vegetativo", expectedStartDay: 45, expectedEndDay: 75,
      ...
      { stageKey: "floracion", label: "Floración / cuaje", expectedStartDay: 75, expectedEndDay: 95,
      ...
      { stageKey: "fructificacion", label: "Fructificación", expectedStartDay: 95, expectedEndDay: 120,
  ...
  },
  {
    ...
    stages: [
      ...
      { stageKey: "vegetativo", label: "Vegetativo (hojas)", expectedStartDay: 55, expectedEndDay: 100,
        irrigationNotes: "Riegos frecuentes hasta bulbificación." },
      { stageKey: "bulbificacion", label: "Bulbificación", expectedStartDay: 100, expectedEndDay: 135,
        irrigationNotes: "Reducir riego al iniciar bulbo." },
      { stageKey: "madurez", label: "Madurez / cosecha", expectedStartDay: 135, expectedEndDay: 150,
  ...
  },
  {
    ...
    stages: [
      ...
      { stageKey: "vegetativo", label: "Vegetativo", expectedStartDay: 40, expectedEndDay: 70,
        taskSuggestions: ["Aporque", "Fertilización N"] },
      { stageKey: "tuberizacion", label: "Tuberización", expectedStartDay: 70, expectedEndDay: 110,
  ...
  },
  {
    ...
    stages: [
      ...
      { stageKey: "floracion", label: "Floración", expectedStartDay: 75, expectedEndDay: 95,
  ...
  },
  {
    ...
    stages: [
      { stageKey: "establecimiento", label: "Establecimiento", expectedStartDay: 0, expectedEndDay: 60 },
  ...
  },
  {
    ...
    stages: [
      ...
      { stageKey: "floracion", label: "Floración", expectedStartDay: 50, expectedEndDay: 70,
...
export function findCrop(name: string | undefined | null): CropDef | undefined {
  ...
  return CROP_CATALOG.find((c) =>
    c.id === k || c.cropName.toLowerCase() === k || c.localName?.toLowerCase() === k
  );
}

export function estimateStage(crop: CropDef, startDate: string, now = new Date()): {
  current?: CropStageDef; dayOffset: number; cycleProgress: number; isOverdue: boolean;
} {
  ...
  const current = crop.stages.find((s) => dayOffset >= s.expectedStartDay && dayOffset < s.expectedEndDay)
...
export const cropCatalogResponseSchema = z.array(z.object({
  id: z.string(), cropName: z.string(), defaultUnit: z.string(), typicalCycleDays: z.number(),
  stages: z.array(z.object({
    stageKey: z.string(), label: z.string(),
    expectedStartDay: z.number(), expectedEndDay: z.number(),
