    ...
    extend: {
      colors: {
        ...
        status: {
          ...
          'offline-soft': 'hsl(var(--status-offline-soft))',
          syncing: 'hsl(var(--status-syncing))',
          'syncing-soft': 'hsl(var(--status-syncing-soft))',
          queued: 'hsl(var(--status-queued))',
          'queued-soft': 'hsl(var(--status-queued-soft))',
        },
        confidence: {
          high: 'hsl(var(--confidence-high))',
          'high-soft': 'hsl(var(--confidence-high-soft))',
          medium: 'hsl(var(--confidence-medium))',
          'medium-soft': 'hsl(var(--confidence-medium-soft))',
          low: 'hsl(var(--confidence-low))',
          'low-soft': 'hsl(var(--confidence-low-soft))',
        },
        stage: {
