import {
  LayoutDashboard, Squircle, Warehouse, Sprout, Droplets, ListChecks,
  NotebookPen, Boxes, PackageCheck, Plug, Settings, BarChart3, Map as MapIcon,
  FlaskConical, Bug, DollarSign,
} from "lucide-react";
import {
...
const groups = [
  ...
  },
  {
    label: "Apicultura",
    items: [
      { title: "Apicultura", url: "/beekeeping", icon: Bug },
    ],
  },
  {
        ...
        <div className="flex items-center gap-2">
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <p className="text-[10px] uppercase tracking-wider text-sidebar-foreground/60">Bolivia · Toco</p>
            </div>
          )}
        </div>
      </SidebarHeader>
