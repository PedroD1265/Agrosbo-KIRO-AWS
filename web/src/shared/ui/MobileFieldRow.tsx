  ...
  return (
    ...
    >
      <div className="flex min-h-[72px] items-start gap-3 px-4 py-3 pl-[15px]">
        ...
        {rightBottom ? <div className="flex shrink-0 items-center">{rightBottom}</div> : onClick ? <ChevronRight className="h-4 w-4 shrink-0 self-center text-muted-foreground" /> : null}
      </div>
    </Wrap>
  );
}
