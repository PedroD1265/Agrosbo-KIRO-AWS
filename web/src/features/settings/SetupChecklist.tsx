  ...
  return (
    ...
    >
      ...
      >
        <div className="min-w-0">
          ...
          <p className="mt-1 text-base font-semibold leading-tight">
            {allDone ? 'Todo listo para operar' : `${done} de ${total} pasos completos`}
          </p>
        ...
        <div
          className={cn(
            ...
            allDone ? 'bg-status-ok text-primary-foreground' : 'bg-primary text-primary-foreground',
          )}
      ...
      <div className="h-1 w-full bg-muted">
        <div
          className={cn('h-full transition-all', allDone ? 'bg-status-ok' : 'bg-primary')}
          style={{ width: `${pct}%` }}
        />
      </div>
