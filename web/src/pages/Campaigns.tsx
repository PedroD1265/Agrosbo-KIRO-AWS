      ...
      <form className="space-y-4" onSubmit={submit}>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select value={field.value} onValueChange={field.onChange}>
                <FormControl>
                  <SelectTrigger data-testid="select-camp-scope">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} data-testid="input-camp-crop" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} data-testid="input-camp-variety" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <div className="grid grid-cols-2 gap-3">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="date" {...field} data-testid="input-camp-start" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Fin estimado</FormLabel>
                <FormControl>
                  <Input type="date" {...field} data-testid="input-camp-end" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select value={field.value} onValueChange={field.onChange}>
                  <FormControl>
                    <SelectTrigger data-testid="select-camp-stage">
                      <SelectValue />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    max={100}
                    {...field}
                    data-testid="input-camp-progress"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
        ...
        <Button type="submit" className="w-full" data-testid="button-submit-camp">
          Crear campaña
        </Button>
      </form>
    </Form>
  ...
  return (
    <Form {...form}>
      <form className="space-y-4" onSubmit={submit}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select value={field.value} onValueChange={field.onChange}>
                  <FormControl>
                    <SelectTrigger data-testid="select-camp-edit-stage">
                      <SelectValue />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select value={field.value} onValueChange={field.onChange}>
                  <FormControl>
                    <SelectTrigger data-testid="select-camp-edit-status">
                      <SelectValue />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    max={100}
                    {...field}
                    data-testid="input-camp-edit-progress"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Fin estimado</FormLabel>
                <FormControl>
                  <Input type="date" {...field} data-testid="input-camp-edit-end" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <Button type="submit" className="w-full" data-testid="button-submit-camp-edit">
          Guardar cambios
        </Button>
      </form>
    </Form>
      ...
      <PageHeader
        ...
        actions={
          <QuickCaptureDrawer
            ...
            trigger={
              <Button size="sm" data-testid="button-new-camp">
                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      data-testid={`button-camp-detail-${c.id}`}
                    >
