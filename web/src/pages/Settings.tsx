                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        {...field}
                        placeholder="Ej. Agrícola San Pedro"
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        {...field}
                        placeholder="Ej. Toco, Cochabamba"
                ...
                render={({ field }) => (
                  <FormItem className="flex items-center justify-between gap-4 space-y-0 py-3 first:pt-0">
                    <div className="min-w-0">
                      ...
                      <p className="mt-0.5 text-xs text-muted-foreground">
                        Capturar siempre como pendiente de sincronizar. Útil para campo con
                    ...
                    <FormControl>
                      <Switch
                        ...
                        data-testid="switch-prefer-offline"
                      />
                    </FormControl>
                  </FormItem>
                )}
                  ...
                  <FormItem className="flex items-center justify-between gap-4 space-y-0 py-3">
                    ...
                    <FormControl>
                      <Switch
                        checked={field.value}
                        onCheckedChange={field.onChange}
                        data-testid="switch-confirm-sync"
                      />
                    </FormControl>
                  </FormItem>
                )}
          ...
          action={
            <Button variant="ghost" size="sm" asChild>
              <Link to="/integrations">
                Integraciones <ChevronRight className="h-4 w-4" />
              </Link>
            </Button>
          }
        >
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <QueueStatTile
                label="Pendientes"
                value={queue.pending}
                tone={queue.pending > 0 ? 'warn' : 'ok'}
              />
              <QueueStatTile
                label="Sincronizando"
                value={queue.syncing}
                tone={queue.syncing > 0 ? 'primary' : 'muted'}
              />
              <QueueStatTile
                label="Errores"
                value={queue.failed}
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              ...
              esta página) requieren rol <code className="rounded bg-muted px-1">admin</code>. Los
              usuarios se crean con <code className="rounded bg-muted px-1">POST /api/users</code>.
            </p>
          </div>
