  ...
  return (
    <Form {...form}>
      <form className="space-y-4" onSubmit={submit}>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Ej: Urea 46%" {...field} data-testid="input-inv-name" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select value={field.value} onValueChange={field.onChange}>
                  <FormControl>
                    <SelectTrigger data-testid="select-inv-category">
                      <SelectValue />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="kg, L, u" {...field} data-testid="input-inv-unit" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="number" step="0.01" {...field} data-testid="input-inv-stock" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="number" step="0.01" {...field} data-testid="input-inv-min" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    {...field}
                    value={field.value ?? ''}
                    data-testid="input-inv-unit-cost"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    {...field}
                    value={field.value ?? ''}
                    data-testid="input-inv-currency"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
        ...
        <Button type="submit" className="w-full" data-testid="button-submit-inv">
          Crear insumo
        </Button>
      </form>
    </Form>
...
function AdjustInventoryForm({ item, onDone }: { item: InventoryItem; onDone: () => void }) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select value={field.value} onValueChange={field.onChange}>
                <FormControl>
                  <SelectTrigger data-testid="select-mov-direction">
                    <SelectValue />
                  </SelectTrigger>
                </FormControl>
                <SelectContent>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" step="0.01" {...field} data-testid="input-mov-amount" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  Costo unitario{' '}
                  {item.unitCost !== undefined ? `(últ. ${item.unitCost})` : '(opcional)'}
                </FormLabel>
                <FormControl>
                  <Input
                    type="number"
                    step="0.01"
                    placeholder={item.unitCost?.toString() ?? '0.00'}
                    {...field}
                    value={field.value ?? ''}
                    data-testid="input-mov-unit-cost"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    {...field}
                    value={field.value ?? ''}
                    data-testid="input-mov-currency"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="Bloque destino, motivo…"
                  {...field}
                  data-testid="input-mov-note"
                />
              </FormControl>
            </FormItem>
          )}
        />
        <Button type="submit" className="w-full" data-testid="button-submit-mov">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Nombre</FormLabel>
              <FormControl>
                <Input {...field} data-testid="input-inv-edit-name" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select value={field.value} onValueChange={field.onChange}>
                  <FormControl>
                    <SelectTrigger data-testid="select-inv-edit-category">
                      <SelectValue />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Unidad</FormLabel>
                <FormControl>
                  <Input {...field} data-testid="input-inv-edit-unit" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" step="0.01" {...field} data-testid="input-inv-edit-min" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        />
        <Button type="submit" className="w-full" data-testid="button-submit-inv-edit">
          Guardar cambios
        </Button>
      </form>
    </Form>
...
export default function InventoryPage() {
  ...
  const filtered = useMemo(() => {
    const base = inventory.filter((i) => {
      const matchesQ =
        q === '' || [i.name, i.category].join(' ').toLowerCase().includes(q.toLowerCase());
    ...
    return [...base].sort((a, b) => {
      switch (sortKey) {
        ...
        case 'stock':
          return sign * (a.stock - b.stock);
        case 'min':
          return sign * (a.min - b.min);
        case 'lastMovement':
          return sign * (a.lastMovement ?? '').localeCompare(b.lastMovement ?? '');
        default:
          return 0;
      }
    });
    ...
    <div className={`space-y-5 animate-fade-in ${isMobile ? 'pb-24' : ''}`}>
        ...
        actions={
          ...
          canWrite && (
            <QuickCaptureDrawer
              ...
              trigger={
                <Button size="sm" data-testid="button-new-inv">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        ...
        <MetricCard
          ...
          value={
            stockValue.total > 0 ? `${stockValue.total.toFixed(2)} ${stockValue.currency}` : '—'
          }
          tone="default"
          hint={
              ...
              <tbody>
                {filtered.map((i) => {
                  ...
                  return (
                    ...
                    >
                      <td
                        className={`px-4 py-3 font-medium ${low ? 'border-l-2 border-status-critical' : ''}`}
                      >
                        {i.name}
                      </td>
                      <td className="px-4 py-3 text-muted-foreground">{i.category}</td>
                      <td
                        className={`px-4 py-3 text-right tabular ${low ? 'font-semibold text-status-critical' : ''}`}
                      >
                        {i.stock}{' '}
                        <span className="text-muted-foreground font-normal">{i.unit}</span>
                      </td>
      ...
      {isMobile && canWrite && (
        <>
          <MobileActionBar
            hint={lowStock.length > 0 ? `${lowStock.length} insumos bajo mínimo` : undefined}
          >
            <Button
              size="lg"
      ...
      >
        {adjustItem && <AdjustInventoryForm item={adjustItem} onDone={() => setAdjustId(null)} />}
      </QuickCaptureDrawer>
